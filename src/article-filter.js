...
ArticleFilter.prototype.filterByTitle = function() {
  this.unfilteredData.filter((article) => {
    ...
    var words = ["Trump", "Harassment", "Groped", "Groping", "Murder", "Murderer", "Murdered", "Rape", "Raping", "Rapist", "Putin", "Missiles", "War", "Battle", "Defiant", "Deaths", "Demands", "Demand", "Killing", "Killer", "Killed", "Brexit", "Racist", "Racism", "Misogynist", "Assault", "Weinstein", "Attack", "Attacker", "Attacks", "ISIS", "Terrorism", "Terrorist", "Conspiracy", "Fallout", "Sad", "Bad"];
